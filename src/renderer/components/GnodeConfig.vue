<template>
<div class="field">
    <p class="tag is-primary" style="font-size:0.85rem;margin-left:-10px">{{ $t("msg.gnodeConfig.warning") }}</p>
    <br/>
    <label class="checkbox" style="font-size:0.95rem;margin-top:20px">
    ...
    <div v-if="useLocalGnode">
      ...
      <label class="label" style="margin-top:17.5px">{{ $t("msg.gnodeConfig.connectMethod") }}:</label>
    ...
    <br/>
    <a class="button is-info is-small" @click="save">{{ $t("msg.save") }}</a>
